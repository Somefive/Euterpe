...
<div class="Wiki_mine">
    ...
    <table class="table table-striped table-bordered" style="text-align: center;">
        <thead>
        <tr><td style="width: 200px;">Title</td><td>Content</td><td>Operator</td></tr>
        </thead>
        <tbody>
        <?php
            ...
            echo('
                  <tr>
                     ...
                     <td>
                        ...
                        <input type="submit" value="编辑"class="btn btn-danger btn-lg" onclick="window.location=\'/course/wiki/compilewiki\'">
                        </form>
